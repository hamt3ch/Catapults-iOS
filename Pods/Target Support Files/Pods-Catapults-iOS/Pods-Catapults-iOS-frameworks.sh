...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods-Catapults-iOS/Bolts.framework"
  install_framework "Pods-Catapults-iOS/CocoaLumberjack.framework"
  install_framework "Pods-Catapults-iOS/FBSDKCoreKit.framework"
  install_framework "Pods-Catapults-iOS/FBSDKLoginKit.framework"
